...
<select id="topic" name="topic">
  <option value="topic1">Travel Summary</option>
  <option value="topic2">Books</option>
</select>
<p> Message </p>
...
&nbsp;&nbsp;&nbsp;&nbsp;
<textarea name="output" style="width:380px" rows="5">${subscribe}</textarea>
<br><br>
</div>
<div class="topright">
...
<br><br>
<textarea class=t1 name="notifications" cols="75">${notification}</textarea>
<br>
